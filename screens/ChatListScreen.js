...
//     const [transientUsers, setTransientUsers] = useState([]);
...
//                     setTransientUsers(filteredUsers);
...
//                         setupProfilePictureListener(user.id); // Added listener for profile picture
//                     });
//                 });
...
//     const setupProfilePictureListener = (userId) => {
//         const userRef = doc(db, 'users', userId);
//         const unsubscribe = onSnapshot(userRef, async (docSnapshot) => {
//             const userData = docSnapshot.data();
//             if (userData.imagePath) {
//                 const imageUrl = await getProfilePictureUrl(userData.imagePath);
//                 setTransientUsers(prevUsers => {
//                     return prevUsers.map(user =>
//                         user.id === userId
//                             ? { ...user, imageUrl }
